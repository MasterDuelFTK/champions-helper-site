...
const ITEM_GROUPS = [
  { label: '위력', items: ['생명의구슬', '달인의띠', '힘의머리띠', '박식안경', '구애머리띠', '구애안경', '전기구슬', '노말주얼'] },
  { label: '스피드', items: ['구애스카프', '검은철구'] },
  // 206차 — 풍선(M-C 신규) = 지닌 동안 땅 기술 무효 / 노말주얼 = 노말 기술 ×1.3(위력 그룹). 엔진(ItemRegistry) 단일 경로.
  { label: '방어', items: ['돌격조끼', '진화의휘석', '풍선'] },
